...
def pop(m):
    st.markdown(f'<div style="position:fixed;left:50%;transform:translateX(-50%);background:#d4edda;color:#155724;padding:12px 24px;border-radius:8px;font-family:sans-serif;font-weight:bold;box-shadow:0 4px 6px #0002;z-index:99999;animation:s 3s forwards">{m}</div><style>@keyframes s{{0%,100%{{top:-99px}}15%,85%{{top:20px}}}}</style>', unsafe_allow_html=True)
